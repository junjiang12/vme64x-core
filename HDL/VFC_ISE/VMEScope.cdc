...
Project.filter<0>=*LWORDinputSample*
...
Project.filter<1>=*LWORDinputSamplee*
Project.filter<2>=*ADDRinputSample*
Project.filter<3>=*AMinputSample*
Project.filter<4>=AM
Project.filter<5>=
